...
setwd("analysis/data/child/data-aggregate")
df <- read.csv(file = "analysis/data/child/data-aggregate/moco-beh-child.csv", header = TRUE,sep=",")
...
rt.pred <- fitted(model.fixed.rt2) # predicted y values
