...
# have shown below.
library(MASS)
nbinom <- fitdistr(na.omit(df2$RT), "Negative Binomial") # a list of non-integer
nbinom <- fitdistr(na.omit(df2$RT), "gamma") # a list of non-integer
nbinom <- fitdistr(na.omit(df2$RT), "logistic")
