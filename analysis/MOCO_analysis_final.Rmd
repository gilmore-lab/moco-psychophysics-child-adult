...
```{r load-files}
df_child <-
  read.csv(file = "~/R/moco-psychophysics/analysis/data/child/data-aggregate/moco-beh-child.csv", header = TRUE)
df_adult <-
  read.csv(file = "~/R/moco-psychophysics/analysis/data/moco-adult.csv", header = TRUE)
df_adult$Speed <-
...
(VarF + VarCorr(model.acc.logit_c)[[1]][1]) / (VarF + VarCorr(model.acc.logit_c)[[1]][1] + (attr(VarCorr(model.acc.logit_c), 'sc') ^
                                                                                              2) + (pi ^ 2) / 3)
...
ggsave(
  plot = p_c,
  filename = "~/R/moco-psychophysics/analysis/pub_image/child.png",
  units = "in",
  height = 12,
  width = 12,
  dpi = 600
...
ggsave(
  plot = p,
  filename = "~/R/moco-psychophysics/analysis/pub_image/adult1.png",
  units = "in",
  height = 12,
  width = 12,
  dpi = 600
