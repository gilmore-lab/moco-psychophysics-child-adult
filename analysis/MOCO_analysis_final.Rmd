...
p0<-ggplot(df_p2_c_acc_pat_coh, aes(x = Coh, y = Pct.Corr*100, color = Pattern, shape=Pattern),  alpha = 0.5) +
  geom_point(data = df_p2_c_acc_pat_coh, aes(x = Coh, y = Pct.Corr.mean, color = Pattern), size = 3, position = position_dodge(0.8)) +   
...
p5<-ggplot(df_p2_a_acc_gen_speed, aes(x = Speed, y = Pct.Corr*100, color = Gender, shape=Gender),  alpha = 0.5) +
  ...
  ylim(30, 100) +
  scale_color_viridis(discrete=TRUE)  +
  annotate("text", x = 0.5, y = 100, label = "b)", size= 12)
p5
...
p6<-ggplot(df_p2_a_acc_gen_pat, aes(x = Pattern, y = Pct.Corr*100, color = Gender, shape=Gender),  alpha = 0.5) +
  ...
  ylim(30,100)+
  scale_color_viridis(discrete=TRUE) +
  annotate("text", x = 0.5, y = 100, label = "c)", size= 12)
p6
